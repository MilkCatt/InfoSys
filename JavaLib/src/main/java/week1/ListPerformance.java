...
public class ListPerformance {
    public static void main(String[] args) {
        ...
        System.out.println("ArrayList: " + accessTime(arrList, count, arrList.size() / 2) + " seconds");    // faster
        ...
        System.out.println("LinkedList: " + accessTime(linList, count, linList.size() - 1) + " seconds");   // faster

        System.out.println("\nInsert item somewhere in the middle of the list");
        System.out.println("ArrayList: " + insertTime(arrList, count, arrList.size() / 2) + " seconds");    // faster
        ...
        System.out.println("LinkedList: " + insertTime(linList, count, 0) + " seconds");    // faster
    }
    // Generally: ArrayList faster for middle, Linked list faster for start/end

    // Note: List is the parent class of ArrayList/LinkedList
    static double accessTime(List list, int count, int idx) {   // List list -> take in either an array/linked list. Diff obj, same methods
